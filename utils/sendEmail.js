  ...
  <div style="font-family: sans-serif; line-height: 1.5; color: #333;">
    <div style="padding: 1rem; border: 1px solid #eee; border-radius: 8px; max-width: 600px; margin: auto;">
      <div style="text-align: center; margin-bottom: 1rem;">
        ...
        <h2 style="color: #0057B7;">Five Star Digital Media</h2>
      </div>
      ${content}
...
export const sendWelcomeEmail = async (email, name) => {
  const html = emailWrapper(`
    <p>Hello ${name},</p>
    <p>Welcome to Five Star Digital Media! Your account has been created successfully.</p>
  ...
  try {
    await resend.emails.send({
      from: 'no-reply@jmmadubuike.eduace.org',
      to: email,
      subject: 'Welcome to Five Star Digital Media',
      html,
    });
  } catch (error) {
